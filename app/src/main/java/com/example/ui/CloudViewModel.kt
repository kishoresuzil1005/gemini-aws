...
class CloudViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _instanceTypeAdvice = MutableStateFlow<List<com.example.api.EC2InstanceType>>(emptyList())
    val instanceTypeAdvice = _instanceTypeAdvice.asStateFlow()

    private val _ec2LaunchTemplates = MutableStateFlow<List<com.example.api.EC2LaunchTemplate>>(emptyList())
    val ec2LaunchTemplates = _ec2LaunchTemplates.asStateFlow()

    private val _ec2SpotRequests = MutableStateFlow<List<com.example.api.EC2SpotRequest>>(emptyList())
    val ec2SpotRequests = _ec2SpotRequests.asStateFlow()

    private val _ec2SavingsPlans = MutableStateFlow<List<com.example.api.EC2SavingsPlan>>(emptyList())
    val ec2SavingsPlans = _ec2SavingsPlans.asStateFlow()

    private val _ec2ReservedInstances = MutableStateFlow<List<com.example.api.EC2ReservedInstance>>(emptyList())
    val ec2ReservedInstances = _ec2ReservedInstances.asStateFlow()

    private val _ec2DedicatedHosts = MutableStateFlow<List<com.example.api.EC2DedicatedHost>>(emptyList())
    val ec2DedicatedHosts = _ec2DedicatedHosts.asStateFlow()

    private val _ec2Amis = MutableStateFlow<List<com.example.api.EC2Ami>>(emptyList())
    val ec2Amis = _ec2Amis.asStateFlow()

    private val _ec2AmiCatalog = MutableStateFlow<List<com.example.api.EC2AmiCatalogItem>>(emptyList())
    val ec2AmiCatalog = _ec2AmiCatalog.asStateFlow()

    private val _ec2Volumes = MutableStateFlow<List<com.example.api.EC2Volume>>(emptyList())
    val ec2Volumes = _ec2Volumes.asStateFlow()

    private val _ec2Snapshots = MutableStateFlow<List<com.example.api.EC2Snapshot>>(emptyList())
    val ec2Snapshots = _ec2Snapshots.asStateFlow()

    private val _ec2SecurityGroups = MutableStateFlow<List<com.example.api.EC2SecurityGroup>>(emptyList())
    val ec2SecurityGroups = _ec2SecurityGroups.asStateFlow()

    private val _ec2ElasticIps = MutableStateFlow<List<com.example.api.EC2ElasticIp>>(emptyList())
    val ec2ElasticIps = _ec2ElasticIps.asStateFlow()

    private val _ec2PlacementGroups = MutableStateFlow<List<com.example.api.EC2PlacementGroup>>(emptyList())
    val ec2PlacementGroups = _ec2PlacementGroups.asStateFlow()

    private val _ec2KeyPairs = MutableStateFlow<List<com.example.api.EC2KeyPair>>(emptyList())
    val ec2KeyPairs = _ec2KeyPairs.asStateFlow()

    private val _ec2NetworkInterfaces = MutableStateFlow<List<com.example.api.EC2NetworkInterface>>(emptyList())
    val ec2NetworkInterfaces = _ec2NetworkInterfaces.asStateFlow()

    private val _ec2LoadBalancers = MutableStateFlow<List<com.example.api.EC2LoadBalancer>>(emptyList())
    val ec2LoadBalancers = _ec2LoadBalancers.asStateFlow()

    private val _ec2TargetGroups = MutableStateFlow<List<com.example.api.EC2TargetGroup>>(emptyList())
    val ec2TargetGroups = _ec2TargetGroups.asStateFlow()
    ...
    fun loadAllEC2ExtendedDetails() {
        viewModelScope.launch {
            ...
            launch {
                try {
                    _ec2InstanceTypes.value = com.example.api.CloudOpsBackendClient.service.getEC2InstanceTypes(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Instance Types Failed", e) }
            }
            launch {
                try {
                    _ec2LaunchTemplates.value = com.example.api.CloudOpsBackendClient.service.getEC2LaunchTemplates(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Launch Templates Failed", e) }
            }
            launch {
                try {
                    _ec2SpotRequests.value = com.example.api.CloudOpsBackendClient.service.getEC2SpotRequests(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Spot Requests Failed", e) }
            }
            launch {
                try {
                    _ec2SavingsPlans.value = com.example.api.CloudOpsBackendClient.service.getEC2SavingsPlans(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Savings Plans Failed", e) }
            }
            launch {
                try {
                    _ec2ReservedInstances.value = com.example.api.CloudOpsBackendClient.service.getEC2ReservedInstances(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Reserved Instances Failed", e) }
            }
            launch {
                try {
                    _ec2DedicatedHosts.value = com.example.api.CloudOpsBackendClient.service.getEC2DedicatedHosts(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Dedicated Hosts Failed", e) }
            }
            launch {
                try {
                    _ec2Amis.value = com.example.api.CloudOpsBackendClient.service.getEC2Amis(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "AMIs Failed", e) }
            }
            launch {
                try {
                    _ec2AmiCatalog.value = com.example.api.CloudOpsBackendClient.service.getEC2AmiCatalog(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "AMI Catalog Failed", e) }
            }
            launch {
                try {
                    _ec2Volumes.value = com.example.api.CloudOpsBackendClient.service.getEC2Volumes(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Volumes Failed", e) }
            }
            launch {
                try {
                    _ec2Snapshots.value = com.example.api.CloudOpsBackendClient.service.getEC2Snapshots(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Snapshots Failed", e) }
            }
            launch {
                try {
                    _ec2SecurityGroups.value = com.example.api.CloudOpsBackendClient.service.getEC2SecurityGroups(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Security Groups Failed", e) }
            }
            launch {
                try {
                    _ec2ElasticIps.value = com.example.api.CloudOpsBackendClient.service.getEC2ElasticIps(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Elastic IPs Failed", e) }
            }
            launch {
                try {
                    _ec2PlacementGroups.value = com.example.api.CloudOpsBackendClient.service.getEC2PlacementGroups(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Placement Groups Failed", e) }
            }
            launch {
                try {
                    _ec2KeyPairs.value = com.example.api.CloudOpsBackendClient.service.getEC2KeyPairs(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Key Pairs Failed", e) }
            }
            launch {
                try {
                    _ec2NetworkInterfaces.value = com.example.api.CloudOpsBackendClient.service.getEC2NetworkInterfaces(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Network Interfaces Failed", e) }
            }
            launch {
                try {
                    _ec2LoadBalancers.value = com.example.api.CloudOpsBackendClient.service.getEC2LoadBalancers(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Load Balancers Failed", e) }
            }
            launch {
                try {
                    _ec2TargetGroups.value = com.example.api.CloudOpsBackendClient.service.getEC2TargetGroups(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Target Groups Failed", e) }
            }
            launch {
                try {
                    _ec2TrustStores.value = com.example.api.CloudOpsBackendClient.service.getEC2TrustStores(reg)
                } catch (e: Exception) { Log.e("CloudViewModel", "Trust Stores Failed", e) }
            }
        }
    }

    fun recommendInstanceTypes(workloadType: String, useCase: String, priority: String, cpuManufacturer: String) {
        viewModelScope.launch {
            if (!_useBackend.value) return@launch
            try {
                val req = com.example.api.InstanceTypeAdviceRequest(workloadType, useCase, priority, cpuManufacturer)
                _instanceTypeAdvice.value = com.example.api.CloudOpsBackendClient.service.getEC2InstanceTypeAdvice(req, _selectedRegion.value)
            } catch (e: Exception) {
                Log.e("CloudViewModel", "Failed to recommend instance types: ${e.message}")
            }
        }
    }
