...
class AISettings:
    def __init__(self):
        self.ollama_url: str = os.getenv("AI_OLLAMA_URL", "http://localhost:11434")
        self.ollama_model: str = os.getenv("AI_OLLAMA_MODEL", "qwen2.5:1.5b")
        self.timeout: int = int(os.getenv("AI_TIMEOUT", "15"))
