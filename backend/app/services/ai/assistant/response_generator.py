...
class ResponseGenerator:
    ...
    def generate(self, question: str, history_str: str, context_str: str, intent: str, target: str, tool_responses: List[ToolResponse], stream: bool = False) -> ChatResponse:
        ...
        answer = self.provider.generate_response(messages=messages, stream=stream)
